      ...
      <div className="lg:flex justify-between items-center">
        <div className="lg:w-[50%] relative">
          ...
          <div className="flex justify-center lg:justify-start mt-[39px]">
            <Link href='/pos-machine-system' onClick={ScrollTop} className="text-white w-[150px] h-[40px] bg-[#4F31B4] rounded-[30px] text-[18.6px] font-medium flex items-center justify-center gap-[3px]">
              Know more{" "}
              <img
