            ...
            <div className='lg:flex justify-between items-center relative'>
                <div className='lg:w-[50%] sm:px-[70px] md:px-[100px] lg:px-0'>
                    ...
                    <div className='flex justify-center lg:justify-start mt-[39px]'>
                          <Link href='/expense-management-tracking-software' onClick={ScrollTop} className="text-white w-[150px] h-[40px] bg-[#4F31B4] rounded-[30px] text-[18.6px] font-medium  flex items-center justify-center gap-[3px]">Know more<img src={KnowMoreRightIcon} alt="" className='h-[13px] w-[13px]' /></Link>
       
                    </div>
                </div>
                <div className='lg:w-[50%] flex justify-center lg:justify-end mt-[80px] lg:mt-0'>
                        <div className="ManagingCorporate-gradient"></div>
                    <img src={'/image/ExpenseManagement/ExpenseHero.webp'} alt="" className='sm:w-[380px] sm::h-[260px]'/>
