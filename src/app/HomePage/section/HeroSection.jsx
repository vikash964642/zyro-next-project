            ...
            <div className="flex flex-col-reverse lg:flex-row items-center gap-5 min-w-full">
              ...
              <div className="lg:w-[55%] w-full">
                ...
                <div className="flex gap-[20px] lg:gap-[35px] items-center mt-[35px] flex-col lg:flex-row">
                  ...
                  >
                    Know more <img src={'image/HomePage/Icon/KnowMoreRightIcon.svg'} className="pl-[4px]" />
                  </Link>
                </div>
              </div>
...
>
 ...
 {index===3 &&(
              ...
              <div className="flex justify-center ">
                ...
                >
                  Know more <img src={'image/HomePage/Icon/KnowMoreRightIcon.svg'} className="pl-[4px] h-[15px] w-[15px]" />
                </Link>
              </div>
            </div>
          </SwiperSlide>
