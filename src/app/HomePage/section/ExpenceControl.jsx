...
const features = [
  {
    ...
    video: "/video/RealTimeTracking.webm",
  },
  {
    label: "Full Automation",
    video: "/video/FullAutomation.webm",
  },
  {
    label: "Custom Controls",
    video: "/video/CustomControl.webm",
  },
  {
    label: "Automatic Reconciliations",
    video: "/video/AutomaticReconciliation.webm",
  },
  {
    label: "Easy Reimbursements",
    video: "/video/EasyReimbursements.webm",
  },
  {
    label: "Smart Dashboards & Reports",
    video: "/video/SamrtDashboardReport.webm",
  },
];
          ...
          {features.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-[20px]">
                <img
                  src={activeIndex === index ? 'image/HomePage/ExpenseRadioChecked.webp' : 'image/HomePage/ExpenseRadioUnChecked.webp'}
