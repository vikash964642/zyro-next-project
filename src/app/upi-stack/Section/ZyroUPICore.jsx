...
function ZyroUPICore() {
  ...
  <div className='flex justify-center pt-[50px] lg:pt-0 relative z-40'>
      <img src={'/image/UPIStack/ZyroUPICoreImg1.webp'} className=' h-[333px] w-[372px] lg:h-[432px] lg:w-[482px] max-[400px]:w-full max-[400px]:h-[300px]   max-[400px]:px-[12px]   relative z-40'/>
  </div>
