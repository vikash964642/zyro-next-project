...
<div className='hidden md:flex justify-center pt-[45px]'>
                   <Link href='/contact-us' className='bg-[#4F31B4] rounded-[24.77px] h-[46px] w-[148px] text-[18px] font-semibold text-[#FFF] flex justify-center items-center'><span onClick={ScrollTop}>Contact Us</span></Link>
</div>
...
<div className='flex md:hidden justify-center pt-[85px] max-[360px]:px-[15px]'>
                   <Link href='/contact-us' className='bg-[#4F31B4] rounded-[24.77px] h-[50px] max-[360px]:w-full w-[325px] text-[22px] font-semibold text-[#FFF] flex justify-center items-center'><span onClick={ScrollTop}>Contact Us</span></Link>
</div>
               </div>
               </section>
  )
